...
impl Serialize for DLsiteProductType {
    ...
    {
        match self {
            DLsiteProductType::Adult => serializer.serialize_str("アダルト"),
            DLsiteProductType::Doujinsji => serializer.serialize_str("同人誌"),
            DLsiteProductType::Software => serializer.serialize_str("ソフトウェア"),
            DLsiteProductType::Game => serializer.serialize_str("ゲーム"),
            DLsiteProductType::Action => serializer.serialize_str("アクション"),
            DLsiteProductType::Adventure => serializer.serialize_str("アドベンチャー"),
            DLsiteProductType::AudioMaterial => serializer.serialize_str("AudioMaterial"),
            DLsiteProductType::Comic => serializer.serialize_str("マンガ"),
            DLsiteProductType::DigitalNovel => serializer.serialize_str("デジタル小説"),
            DLsiteProductType::Other => serializer.serialize_str("その他"),
            DLsiteProductType::OtherGame => serializer.serialize_str("その他のゲーム"),
            DLsiteProductType::Illust => serializer.serialize_str("イラスト"),
            DLsiteProductType::ImageMaterial => serializer.serialize_str("ImageMaterial"),
            DLsiteProductType::Manga => serializer.serialize_str("マンガ"),
            DLsiteProductType::Anime => serializer.serialize_str("アニメ"),
            DLsiteProductType::Music => serializer.serialize_str("音楽"),
            DLsiteProductType::Novel => serializer.serialize_str("小説"),
            DLsiteProductType::Puzzle => serializer.serialize_str("パズル"),
            DLsiteProductType::Quiz => serializer.serialize_str("クイズ"),
            DLsiteProductType::RolePlaying => serializer.serialize_str("ロールプレイング"),
            DLsiteProductType::Gekiga => serializer.serialize_str("劇画"),
            DLsiteProductType::Simulation => serializer.serialize_str("シミュレーション"),
            DLsiteProductType::Voice => serializer.serialize_str("音声"),
            DLsiteProductType::Shooter => serializer.serialize_str("Shooter"),
            DLsiteProductType::Tabletop => serializer.serialize_str("Tabletop"),
            DLsiteProductType::Utility => serializer.serialize_str("ユーティリティ"),
            DLsiteProductType::Typing => serializer.serialize_str("タイピング"),
            DLsiteProductType::SexualNovel => serializer.serialize_str("成人向け小説"),
            DLsiteProductType::VoiceComic => serializer.serialize_str("ボイスコミック"),
...
impl Display for DLsiteProductAgeCategory {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            DLsiteProductAgeCategory::All => write!(f, "すべて"),
...
impl Serialize for DLsiteProductAgeCategory {
    ...
    {
        match self {
            DLsiteProductAgeCategory::All => serializer.serialize_str("すべて"),
